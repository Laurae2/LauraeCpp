...
#' \item{\code{addLp.integer}}{ for integer}
#' \item{\code{addLp.numeric}}{ for numeric}
#' }
#'
...
#' @return \code{x + y}.
#'
#' @aliases addLp.integer addLp.numeric Rcpp_addLp_int Rcpp_addLp_num
#'
#' @examples
#'
#' # Random data
...
#' system.time({
#'   z1 <- addLp(x = x, y = y, nthread = 1)
#' })
#'
#' # Multithreaded version
#' system.time({
#'   z2 <- addLp(x = x, y = y, nthread = 2)
#' })
#'
#' # Proof check
...
#' })
#' system.time({
#'   z2 <- addLp(x = x, y = y, nthread = parallel::detectCores())
#' })
...
addLp.integer <- function(x, y, nthread = parallel::detectCores()) {

  return(Rcpp_addLp_int(x, y, nthread))

}

addLp.numeric <- function(x, y, nthread = parallel::detectCores()) {
